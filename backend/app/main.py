...
from app.routes import emergency_simple  # ADD THIS LINE
...
# CORS configuration - This is already correct
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
...
app.include_router(emergency_simple.router, prefix="/api/v1/emergency", tags=["Emergency Simple"])  # ADD THIS LINE
